  ...
  return (
    	<div className={unitClasses}>
      	<div className={styles.buttongroup} id="amount-units">
      		<input type="radio" id="bg2_1" name="bg2" value="shot" onClick={setUnits} defaultChecked />
      		<label htmlFor="bg2_1">
        		<span className={styles.unit}>shot</span>
        		<Icon icon='shot' className={styles.icon} />
        		<span className={styles.conversion}>1 fluid oz</span>
      		</label>
      		<input type="radio" id="bg2_2" name="bg2" value="jigger" onClick={setUnits} />
      		<label htmlFor="bg2_2">
      		...
      		<input type="radio" id="bg2_3" name="bg2" value="cup" onClick={setUnits} />
      		<label htmlFor="bg2_3">
